...
def uploaded_chest():
   ...
   resnet_chest = load_model('models/resnet_chest.hdf5')
   vgg_chest = load_model('models/vgg_chest.hdf5')
   inception_chest = load_model('models/inceptionv3_chest.hdf5')
   xception_chest = load_model('models/xception_chest.hdf5')
...
def uploaded_ct():
   ...
   resnet_ct = load_model('models/resnet_ct.hdf5')
   vgg_ct = load_model('models/vgg_ct.hdf5')
   inception_ct = load_model('models/inception_ct.hdf5')
   xception_ct = load_model('models/xception_ct.hdf5')
